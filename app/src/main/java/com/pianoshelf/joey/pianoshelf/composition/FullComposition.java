 ...
 * Querying the API through a search/filter no longer returns a fully complete FullComposition object
 * Always check null condition before accessing fields
 * Needs a util that automatically queries the full FullComposition object given an id/composition
 * <p/>
...
public class FullComposition implements Composition {
